...
const NavV2ExternalLinks = ({ phone, phoneNumber, phoneHref, listings, whiteIcon }) => {
    const iconClasses = ['navV2__phone--icon'];
    ...
    return (
        <Fragment>
                {phone && <Link href={phoneHref}>
                    <div className="navV2__phone">
                        ...
                        <div className="navV2__phone--copy">
                            <span>Rent Today</span>
                            <span className="themeHeader">{phoneNumber}</span>
                        </div>
                    </div>
                </Link>}

                {listings && <a href="#listings">
                    <div className="btn themeBtn">Find My Apartment</div>
                </a>}

                {tenantServices && <div className="navV2__portal"><AppPopup trigger={TenantServicesTrigger} copy={tenantServices.copy} /></div>}
        </Fragment>
    )
}

export default NavV2ExternalLinks;