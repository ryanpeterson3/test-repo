...
const HerosRidgeHero = ({
    ...
    const renderCopy = () => (
        <div className="imageCopyBlock__copy--wrapper" data-type="copy">
            ...
            {herosRidge && herosRidge.btnCopy && pdf && <a href={pdf} className="btn imageCopyBlock__btn" onClick={() => formDownload()}>{herosRidge.btnCopy}</a>}
    ...
    const renderCommercial = () => (
        <section className={containerClasses.join(' ')} id={id} data-type={type} data-aos="fade">
