...
const PropertyMapCardV3 = ({ type, title, image, etas, coords, city }) => {
    return (
        <a href={`https://www.google.ca/maps/?q=${title}+${city}`} target="_blank" rel="noreferrer">
            <div className="propertyMapV3__card" data-card={type}>
                <div className="propertyMapV3__card--header themeBGLight">
                    <h3>{title}</h3>
                </div>

                <div className="propertyMapV3__card--image" data-card={type}>
                    {ImageLoader(image, '', title, 526, 330, 10)}
                </div>

                <div className="propertyMapV3__card--etas themeBGLight">
                    <div className="propertyMapV3__card--time" data-eta="walk">
                        <div className="propertyMapV3__card--icon themeETA">
                    ...
                    <div className="propertyMapV3__card--time" data-eta="bike">
                        <div className="propertyMapV3__card--icon themeETA">
                    ...
                    <div className="propertyMapV3__card--time" data-eta="drive">
                        <div className="propertyMapV3__card--icon themeETA">
...
export default PropertyMapCardV3;