...
const NavExternalLinks = ({ phone, phoneNumber, phoneHref, listings, whiteIcon, copy }) => {
    ...
    return (
        <Fragment>
                        ...
                        <div className={iconClasses.join(' ')}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38">
                                <g id="Group_14239" data-name="Group 14239" transform="translate(-6 -2)">
                                    <circle id="Ellipse_48" data-name="Ellipse 48" cx="19" cy="19" r="19" transform="translate(6 2)" fill="#8c857b"/>
                ...
                {tenantServices && <div className="nav__portal" onClick={() => submitGAEvent('tenant_portal_clicked')}><AppPopup trigger={TenantServicesTrigger} copy={tenantServices.copy} /></div>}
        </Fragment>
    )
}
