...
// Filename: Suite 210.ggsk
// Generated 2023-02-08T16:16:20
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._map_1.logicBlock_size = function() {
			...
			if (me._map_1.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._map_1.ggCurrentLogicStateSize == 0) {
					me._map_1.style.width='750px';
					me._map_1.style.height='737px';
					skin.updateSize(me._map_1);
				}
				else if (me._map_1.ggCurrentLogicStateSize == 1) {
					me._map_1.style.width='500px';
					me._map_1.style.height='492px';
					skin.updateSize(me._map_1);
				}
				else if (me._map_1.ggCurrentLogicStateSize == 2) {
					me._map_1.style.width='300px';
					me._map_1.style.height='295px';
					skin.updateSize(me._map_1);
				}
				else if (me._map_1.ggCurrentLogicStateSize == 3) {
					me._map_1.style.width='0px';
					me._map_1.style.height='0px';
					skin.updateSize(me._map_1);
				}
				else {
					me._map_1.style.width='750px';
		...
		me._map_1.ggRadar.update=function() {
			...
			if ((me._map_1.ggSimpleFloorplanMarkerArray.hasOwnProperty(currentId)) && filterpassed) {
				...
				radarPath.setAttributeNS(null,'fill', '#7f7f7f');
				radarPath.setAttributeNS(null,'fill-opacity', 0.35);
				radarPath.setAttributeNS(null,'stroke', '#7f7f7f');
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		hs='data:image/svg+xml;base64,'+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
...
this.__div.style.top = vs.height / 2 + "px";
	...
	function SkinElement_map_node_Class(parentScope,ggParent) {
		...
		hs+='background : #00657f;';
		hs+='border : 6px solid #414143;';
		hs+='cursor : default;';
		hs+='height : 12px;';
		hs+='left : -10000px;';
		hs+='position : absolute;';
	...
	player.addListener('sizechanged', function(args) { me._map_1.logicBlock_size(); });
